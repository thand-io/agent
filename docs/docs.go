...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ElevateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ElevateLLMRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/execution/{id}/approvals": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Approval processed and workflow signaled",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.ProviderResourcesResponse"
                        }
                    },
                    "404": {
                        "description": "Provider not found",
        ...
        "/provider/{provider}/tenants": {
            "get": {
                ...
                "responses": {
                    ...
                    "501": {
                        "description": "Provider does not implement tenants",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_thand-io_agent_internal_models.RolesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/sessions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of sessions with default provider",
                        "schema": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Provider selection request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SessionSetDefaultRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Provider session not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_thand-io_agent_internal_models.WorkflowsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "daemon.ExecutionsPageData": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/daemon.SimpleConfig"
                },
                "environment": {
                    "$ref": "#/definitions/daemon.SimpleEnvrinment"
                },
                "executions": {
                    "type": "array",
                    "items": {
        ...
        "daemon.SimpleConfig": {
            ...
            "properties": {
                ...
                "server": {
                    "$ref": "#/definitions/daemon.SimpleServer"
                },
                "services": {
                    "$ref": "#/definitions/daemon.SimpleServices"
                }
            }
        },
        "daemon.SimpleEnvrinment": {
            "type": "object",
            "properties": {
                "platform": {
                    "type": "string"
        ...
        "daemon.SimpleServer": {
            ...
            "properties": {
                "capabilities": {
                    "$ref": "#/definitions/models.CapabilitiesConfig"
                },
                "health": {
                    "$ref": "#/definitions/daemon.SimpleHealth"
                },
                "host": {
                    "type": "string"
                },
                "metrics": {
                    "$ref": "#/definitions/daemon.SimpleMetrics"
                },
                "port": {
                    "type": "integer"
                }
        ...
        "github_com_thand-io_agent_internal_config.ProviderDefinitionsConfig": {
            "type": "object",
            "properties": {
                "definitions": {
                    "description": "Load providers directly from config using mapstructure:\",remain\"",
        ...
        "github_com_thand-io_agent_internal_config.RegistrationRequest": {
            ...
            "properties": {
                ...
                "endpoint": {
                    "description": "Login server endpoint",
                    "type": "string"
                },
                "environment": {
                    "$ref": "#/definitions/github_com_thand-io_agent_internal_models.EnvironmentConfig"
                },
                "identifier": {
                    "type": "string"
                },
                ...
                "origin": {
                    "description": "Where the agent is running, used for logging and analytics",
                    "type": "string"
                },
                "version": {
                    "type": "string"
        ...
        "github_com_thand-io_agent_internal_config.RegistrationResponse": {
            ...
            "properties": {
                ...
                "providers": {
                    "$ref": "#/definitions/github_com_thand-io_agent_internal_config.ProviderDefinitionsConfig"
                },
                "roles": {
        ...
        "github_com_thand-io_agent_internal_models.ElevateLLMRequest": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string"
        ...
        "github_com_thand-io_agent_internal_models.ElevateRequest": {
            "type": "object",
            "properties": {
                "authenticator": {
                ...
                "tenants": {
                    "description": "Optional tenant IDs for multi-account providers",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "github_com_thand-io_agent_internal_models.EnvironmentConfig": {
            "type": "object",
            "properties": {
                "architecture": {
        ...
        "github_com_thand-io_agent_internal_models.ProviderPermission": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_thand-io_agent_internal_models.ProviderResource": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
                ...
                "metadata": {
                    "description": "Store additional metadata if needed",
                    "type": "object",
                    "additionalProperties": {}
                },
                "name": {
        ...
        "github_com_thand-io_agent_internal_models.ProvidersResponse": {
            ...
            "properties": {
                "meta": {
                    "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ResponseMeta"
                },
                "providers": {
                    "type": "array",
                    "items": {
        ...
        "github_com_thand-io_agent_internal_models.ResponseMeta": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
        ...
        "github_com_thand-io_agent_internal_models.Role": {
            ...
            "properties": {
                ...
                "identifier": {
                    "description": "To be set by the system",
                    "type": "string"
                },
                "inherits": {
        ...
        "github_com_thand-io_agent_internal_models.RoleResponse": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "github_com_thand-io_agent_internal_models.RolesResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ResponseMeta"
                ...
                "roles": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/github_com_thand-io_agent_internal_models.RoleResponse"
                            }
                        }
                    }
                },
        ...
        "github_com_thand-io_agent_internal_models.ServicesConfig": {
            ...
            "properties": {
                ...
                "publicKeyInfrastructure": {
                    "description": "Public Key Infrastructure - used for managing keys and certificates",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.PublicKeyInfrastructureConfig"
                        }
                    ]
                },
                "scheduler": {
        ...
        "github_com_thand-io_agent_internal_models.WorkflowResponse": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_thand-io_agent_internal_models.WorkflowsResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ResponseMeta"
                ...
                "workflows": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/github_com_thand-io_agent_internal_models.WorkflowResponse"
                            }
                        }
                    }
                }
        ...
        "model.AuthenticationPolicy": {
            ...
            "properties": {
                ...
                "proxy_bearer": {
                    "$ref": "#/definitions/model.ProxyBearerAuthenticationPolicy"
                }
            }
        },
        ...
        "model.ProxyBearerAuthenticationPolicy": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
        ...
        "models.CapabilitiesConfig": {
            "type": "object",
            "properties": {
                "elevations": {
                    "$ref": "#/definitions/models.ElevationsConfig"
                }
            }
        },
        "models.DynamicElevationsConfig": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean",
        ...
        "models.ElevationsConfig": {
            "type": "object",
            "properties": {
                "dynamic": {
                    "$ref": "#/definitions/models.DynamicElevationsConfig"
                },
                "llm": {
                    "$ref": "#/definitions/models.LargeLanguageModelElevationsConfig"
                },
                "static": {
                    "$ref": "#/definitions/models.StaticElevationsConfig"
                }
            }
        },
        ...
        "models.GroupsConfiguration": {
            ...
            "properties": {
                ...
                "interval": {
                    "description": "in minutes (max 30 days)",
                    "type": "integer",
                    "maximum": 43200,
                    "minimum": 1
                },
        ...
        "models.IdentitiesConfiguration": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
        ...
        "models.LargeLanguageModelElevationsConfig": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean",
        ...
        "models.PermissionsConfiguration": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
                ...
                "permissions": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ProviderPermission"
                            }
                        }
                    }
                },
        ...
        "models.ProviderResourcesResponse": {
            "type": "object",
            "properties": {
                "provider": {
                    "type": "string"
                ...
                "resources": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ProviderResource"
                            }
                        }
                    }
                },
                ...
                "roles": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/github_com_thand-io_agent_internal_models.ProviderRole"
                            }
                        }
                    }
                },
        ...
        "models.ProviderTenantsResponse": {
            "type": "object",
            "properties": {
                "provider": {
                    "type": "string"
                ...
                "tenants": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "_source": {
                                "$ref": "#/definitions/models.ProviderTenant"
                            }
                        }
                    }
                },
        ...
        "models.PublicKeyInfrastructureConfig": {
            "type": "object",
            "properties": {
                "config": {
                    "description": "Provider-specific configuration",
                ...
                "provider": {
                    "description": "aws|gcp|azure|local (defaults to environment platform)",
                    "type": "string"
                }
            }
        },
        "models.ResourcesConfiguration": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
        ...
        "models.SessionsResponse": {
            ...
            "properties": {
                "defaultProvider": {
                    "description": "Current default provider from cookie",
                    "type": "string"
                },
                "sessions": {
                    "description": "Map of provider name to session",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/github_com_thand-io_agent_internal_models.LocalSession"
                    }
