...
func ListenTaskHandler(
	...
	if workflowTask.HasTemporalContext() {
		...
		workflowSelector.AddReceive(resumeChan, func(c workflow.ReceiveChannel, more bool) {
			...
			input = resumeableWorkflow.GetInput()
...
func evaluateListenFilter(workflowTask sdkWorkflowsModel.WorkflowTaskSupport, eventFilter *model.EventFilter, signal cloudevents.Event) bool {
...
func evaluateAnyListener(workflowTask sdkWorkflowsModel.WorkflowTaskSupport, anyListener []*model.EventFilter, signal cloudevents.Event) bool {
...
func evaluateAllListener(workflowTask sdkWorkflowsModel.WorkflowTaskSupport, allListener []*model.EventFilter, signal cloudevents.Event) bool {
