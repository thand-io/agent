...
func DecodeLocalSudoRequest(value *CompositeRole) (LocalSudoRequestMetadata, error) {
...
func DecodeLocalSudoAuthorization(value *CompositeRole) (LocalSudoAuthorizationMetadata, error) {
...
func NormalizeLocalSudoRequest(
	...
	providers map[string]ProviderConfig,
		...
		meta, err := DecodeLocalSudoRequestMetadata(request.Role)
		if err != nil {
			return err
		}
