...
func (f *formNotifier) addFormActionSection(blocks *[]slack.Block, workflowTask *models.ElevateWorkflowTask) {
...
func (f *formNotifier) createFormUrl(workflowTask *models.ElevateWorkflowTask) string {
